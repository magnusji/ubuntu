...
function setup_environment {
  ...
  URL="http://www.uio.no/tjenester/it/nett/tradlost/"
  SUPPORT="it-support@uio.no"
if [ ! -z "$DISPLAY" ] ; then
...
if ! ask "This installer will only work properly if you are a member of ${bf}Universitetet i Oslo.${n}" "Continue" 1 ; then exit; fi
